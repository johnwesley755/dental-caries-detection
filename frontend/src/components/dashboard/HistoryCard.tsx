  ...
  const getStatusBadge = (status: DetectionStatus) => {
    switch (status) {
      ...
      case DetectionStatus.REVIEWED:
        return <Badge className="bg-blue-100 text-primary border-none shadow-none font-medium hover:bg-blue-100">Reviewed</Badge>;
      default:
    ...
    >
      <CardContent className="p-0">
        <div className="p-5">
          <div className="flex justify-between items-start mb-3">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-full bg-blue-50 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
        ...
        <div className="px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
          ...
          <ArrowRight className="h-4 w-4 text-gray-300 group-hover:text-primary transform group-hover:translate-x-1 transition-all" />
        </div>
      </CardContent>
    </Card>
  );
