        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.1]">
              Dental care that <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-900 via-emerald-600 to-purple-600">
                actually feels good.
              </span>
            </h2>
              ...
              {!isAuthenticated ? (
                <>
                  ...
                  <Button 
                    ...
                    className="h-16 px-10 text-lg rounded-full border-slate-200 text-slate-600 hover:bg-white hover:text-blue-900 hover:border-blue-200 shadow-sm hover:shadow-md transition-all bg-white/50 backdrop-blur-sm"
                  >
                    Sign In
                  </Button>
                </>
                ...
                <Button 
                  ...
                  className="h-16 px-12 text-lg rounded-full bg-blue-900 hover:bg-blue-950 text-white shadow-xl shadow-primary/30 hover:scale-105 transition-all"
                >
                  Go to Dashboard
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
