    ...
    <footer className="bg-white border-t border-slate-100 pt-20 pb-10">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Link to="/" className="flex items-center gap-2 group">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-900 text-white shadow-lg shadow-blue-200 transition-transform group-hover:scale-105">
                <Stethoscope className="h-5 w-5" />
              </div>
              <span className="text-xl font-bold text-slate-900 tracking-tight">DENTALAI</span>
            </Link>
            ...
            <div className="flex gap-4">
              {[Twitter, Linkedin, Facebook, Instagram].map((Icon, i) => (
                <a 
                  key={i} 
                  href="#" 
                  className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-blue-50 hover:text-blue-900 transition-all duration-300"
                >
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500">
              {['Features', 'AI Analysis', 'Security', 'Enterprise', 'Pricing'].map((item) => (
                <li key={item}>
                  <a href="#" className="hover:text-blue-900 transition-colors">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <form className="flex gap-2">
              ...
              <button className="h-10 px-4 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-blue-900 transition-colors flex items-center gap-2">
        ...
        <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-400">
          <p>© 2024 DENTALAI Intelligence. All rights reserved.</p>
