        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Link to="/" className="flex items-center gap-2 group">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-teal-600 text-white shadow-lg shadow-teal-200 transition-transform group-hover:scale-105">
            ...
            <div className="flex gap-4">
              {[Twitter, Linkedin, Facebook, Instagram].map((Icon, i) => (
                <a 
                  key={i} 
                  href="#" 
                  className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-teal-50 hover:text-teal-600 transition-all duration-300"
                >
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500">
              {['Features', 'AI Analysis', 'Security', 'Enterprise', 'Pricing'].map((item) => (
                <li key={item}>
                  <a href="#" className="hover:text-teal-600 transition-colors">{item}</a>
                </li>
              ))}
            </ul>
          </div>
            ...
            <form className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full h-10 pl-10 pr-4 rounded-lg border border-slate-200 bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-teal-100 focus:border-teal-300 transition-all"
                />
              </div>
              <button className="h-10 px-4 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-teal-600 transition-colors flex items-center gap-2">
